...
const INITIAL_SETTINGS: Settings = {
  ...
  telegramBotToken: import.meta.env.VITE_TELEGRAM_TOKEN || "8797580854:AAHOd0Aqo6MD_qt3b37N0wLlkomlYs0w1dM",
  telegramChatId: import.meta.env.VITE_TELEGRAM_CHAT_ID || "-10037475752800",
...
const App: React.FC = () => {
  ...
  const renderView = () => {
    switch (activeView) {
      ...
      case 'SERVICES': return <Services repairTickets={repairTickets} setRepairTickets={setRepairTickets} rentalContracts={rentalContracts} setRentalContracts={setRentalContracts} contacts={contacts} setContacts={setContacts} transactions={transactions} setTransactions={setTransactions} settings={settings} onNotify={notifyTelegram} />;
